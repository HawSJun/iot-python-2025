...
- 깃허브[데스크톱]
    1. **fetch orign** : 리모트 최신 변경사항 확인(중요!)
...
https://github.com/user-attachments/assets/37fff7f0-3549-41c2-82d6-85b3f54c9455
...
- 파이썬 응용
    ...
    - 토이 프로젝트
        ...
        - 공의 시작 방향, 경계부분 문제 해결, 종료 후 다시 시작 로직
