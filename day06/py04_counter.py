...
buttonUp = Button(root, text='카운트', font=myfont, command=countUp) # countUp이라는 함수가 마우스 클릭때마다 살행
buttonUp.pack(side=LEFT, padx=20, pady=20)
buttonInit = Button(root, text='초기화', font=myfont, command=countInit) # coountInit 함수가 실행
