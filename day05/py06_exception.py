...
##    오류 표시가 안나는 코딩을 잘못한 오류 포함(!) mul(7, 6) -> 42 예상, 결과 13
...
## except 예외클래스 as e:
##    예외처리 로직
## Exception 클래스는 다른 모든 예외 클래스의 조상, Exception만 쓰면됨
## [finally:] - 옵션
##    예외발생 유무와 상관없이 항상 처리해 할 로직
## try문을 반복해서 사용하지 말 것 - 속도 느려짐

# 디버깅 - 천천히 어디에서 예외()가 발생하는지 확인하기 위해 사용
